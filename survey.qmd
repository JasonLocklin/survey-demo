...
Welcome! This is a short and fun quiz to test your knowledge of the R language and learn a bit about your experience.
...
sd_question(
  ...
  label = 'R started out as a project to re-write the S launguage for running on what type of computer?',
